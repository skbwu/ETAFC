...
# unpack our settings based on command-line input! ONE RUN PER SCRIPT!
shuffle, log_trans, fh, num_lags, cluster_mech, num_nodes = settings[int(sys.argv[1])]
...
class Model(torch.nn.Module):
    ...
    def __init__(self):
        ...
        self.gcn = TGCN(in_channels=num_lags, out_channels=num_nodes)
...
predictions.to_csv(f"tgcn_results/{fname}", index=False)